...
SECRET_KEY = 'django-insecure-j(f@0wq%u)$9aa4*5%1ucc%8sr1q634)h)kv=2yi4)tmd-6+f9'
...
ROOT_URLCONF = 'backendARealu.urls'
...
WSGI_APPLICATION = 'backendARealu.wsgi.application'
